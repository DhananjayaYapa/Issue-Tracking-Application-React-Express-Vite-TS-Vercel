...
export const getStatusIcon = (status: string) => {
    switch (status) {
        case 'Open': return <OpenIcon color="info" />;
...
export const getPriorityIcon = (priority: string) => {
    switch (priority) {
        case 'Low': return <LowIcon color="success" />;
        case 'Medium': return <MediumIcon color="warning" />;
        case 'High': return <HighIcon color="error" />;
        case 'Critical': return <CriticalIcon color="error" />;
        default: return <MediumIcon />;
    }
}
